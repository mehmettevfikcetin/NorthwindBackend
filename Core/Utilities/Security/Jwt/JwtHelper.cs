...
namespace Core.Utilities.Security.Jwt
{
    ...
    {   
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var jwt = CreateJwtSecurationToken(_tokenOptions, user, signingCredentials, operationClaims);
        ...
        public JwtSecurityToken CreateJwtSecurationToken(TokenOptions tokenOptions, User user ,SigningCredentials signingCredentials, List<OperationClaim> operationClaims) 
        {
